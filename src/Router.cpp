...
const ServerConfig* Router::findServer(const Config& config, const HttpRequest& request) {
...
const LocationConfig* Router::findLocation(const ServerConfig& serverConfig, const std::string& path) {
