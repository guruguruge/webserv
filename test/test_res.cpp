...
void test_BuildResponse()
{
    ...
    {
        std::cout << GREEN << "[PASS] Response format looks correct." << RESET << std::endl;
    }
    else
    {
...
void test_SendingLoop()
{
    ...
    while (!res.isDone())
    {
        ...
        std::cout << "Sending " << sendChunk << " bytes... (Remaining: " << remain << ")" << std::endl;
    ...
    {
        std::cout << GREEN << "[PASS] All bytes sent correctly." << RESET << std::endl;
    }
    else
    {
